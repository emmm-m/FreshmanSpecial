...
public class WheelView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (dividerType == DividerType.WRAP){//横线长度仅包裹内容
            ...
            //zia
            paintCustom.setColor(Color.parseColor("#81C0FE"));
            paintCustom.setStyle(Paint.Style.FILL);
            canvas.drawRect(startX,firstLineY,endX,secondLineY,paintCustom);
            //zia
        }else {
            ...
            paintCustom.setColor(Color.parseColor("#81C0FE"));
            paintCustom.setStyle(Paint.Style.FILL);
            canvas.drawRect(0.0F,firstLineY,measuredWidth,secondLineY,paintCustom);
            //zia
        }
